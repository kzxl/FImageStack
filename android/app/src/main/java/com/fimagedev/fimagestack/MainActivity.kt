                    ...
                    when (state.screenState) {
                        AppScreenState.CameraCapture -> {
                            CameraCaptureScreen(
                                ...
                                liveManualDiopters = state.liveManualDiopters,
                                ...
                                isMosaicMode = state.isMosaicMode,
                                mosaicTiles = state.mosaicTiles,
                                activeMosaicIndex = state.activeMosaicIndex,
                                onFocusModeChanged = { viewModel.setFocusMode(it) },
                                onLiveDioptersChanged = { viewModel.setLiveManualFocus(it) },
                                onSetNearPoint = { viewModel.setNearCalibrationPoint() },
                                onSetFarPoint = { viewModel.setFarCalibrationPoint() },
                                ...
                                onToggleMosaicMode = { viewModel.toggleMosaicMode() },
                                onSelectMosaicTile = { viewModel.selectMosaicTile(it) },
                                onStitchAllMosaicTiles = { viewModel.stitchAllMosaicTiles() },
